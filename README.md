...
| Page         | URL                                                    |
| ------------ | ------------------------------------------------------ |
| Home      | [pridebot.xyz](https://pridebot.xyz)                   |
| Partners  | [pridebot.xyz/partners](https://pridebot.xyz/partners) |
| Premium   | [pridebot.xyz/premium](https://pridebot.xyz/premium)   |
| PFP Maker | [pfp.pridebot.xyz](https://pfp.pridebot.xyz)           |
| Profiles  | [profile.pridebot.xyz](https://profile.pridebot.xyz)   |

### Legal

| Document            | URL                                                  |
| ------------------- | ---------------------------------------------------- |
| Terms of Service | [pridebot.xyz/tos](https://pridebot.xyz/tos)         |
| Privacy Policy   | [pridebot.xyz/privacy](https://pridebot.xyz/privacy) |

### Community

| Platform   | Link                                                             |
| ---------- | ---------------------------------------------------------------- |
| Discord | [Support Server](https://pridebot.xyz/support)                   |
| GitHub  | [Pridebot-Systems](https://github.com/Pridebot-Systems)          |
